...
public class MultiplyHardQuiz extends AppCompatActivity {
    ...
    private void checkAnswer(boolean isCorrect, TextView selectedAnswer) {
        ...
        if (currentQuestions < questionsItems.size() - 1) {
            ...
            Intent intent = new Intent(MultiplyHardQuiz.this, ResultActivity.class);
    ...
    private void loadAllQuestions() {
        ...
        String jsonquiz = loadJsonFromAsset("multiply/hardquestions.json");
        try {
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(MultiplyHardQuiz.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(MultiplyHardQuiz.this, MainActivity2.class));
                finish();
            }
        });
