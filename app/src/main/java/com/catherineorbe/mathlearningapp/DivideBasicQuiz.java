...
public class DivideBasicQuiz extends AppCompatActivity {
    ...
    private void checkAnswer(boolean isCorrect, TextView selectedAnswer) {
        ...
        if (currentQuestions < questionsItems.size() - 1) {
            ...
            Intent intent = new Intent(DivideBasicQuiz.this, ResultActivity.class);
    ...
    private void loadAllQuestions() {
        ...
        String jsonquiz = loadJsonFromAsset("division/easyquestions.json");
        try {
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(DivideBasicQuiz.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(DivideBasicQuiz.this, MainActivity2.class));
                finish();
            }
        });
