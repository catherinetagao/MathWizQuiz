...
public class DivideHardQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_divide_hard_quiz);
    ...
    private void checkAnswer(boolean isCorrect, TextView selectedAnswer) {
        ...
        if (currentQuestions < questionsItems.size() - 1) {
            ...
            Intent intent = new Intent(DivideHardQuiz.this, ResultActivity.class);
    ...
    private void loadAllQuestions() {
        ...
        String jsonquiz = loadJsonFromAsset("division/hardquestions.json");
        try {
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(DivideHardQuiz.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(DivideHardQuiz.this, MainActivity2.class));
                finish();
            }
        });
