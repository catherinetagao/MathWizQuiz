...
public class SubtractionBasicQuiz extends AppCompatActivity {
    ...
    int timePerQuestion = 10000; // 10 seconds per question
    int progressStep;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtraction_basic_quiz);
    ...
    private void checkAnswer(boolean isCorrect, TextView selectedAnswer) {
        ...
        if (currentQuestions < questionsItems.size() - 1) {
            ...
            Intent intent = new Intent(SubtractionBasicQuiz.this, ResultActivity.class);
    ...
    private void loadAllQuestions() {
        ...
        String jsonquiz = loadJsonFromAsset("minus/easyquestions.json");
        try {
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(SubtractionBasicQuiz.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(SubtractionBasicQuiz.this, MainActivity2.class));
                finish();
            }
        });
