...
public class MultiplyClassicQuiz extends AppCompatActivity {
    ...
    private void checkAnswer(boolean isCorrect, TextView selectedAnswer) {
        ...
        if (currentQuestions < questionsItems.size() - 1) {
            ...
            Intent intent = new Intent(MultiplyClassicQuiz.this, ResultActivity.class);
    ...
    private void loadAllQuestions() {
        ...
        String jsonquiz = loadJsonFromAsset("multiply/mediumquestions.json");
        try {
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(MultiplyClassicQuiz.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(MultiplyClassicQuiz.this, MainActivity2.class));
                finish();
            }
        });
