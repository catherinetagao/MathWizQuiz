    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, final int position, @NonNull MainModel model) {
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EditText course = (EditText) view.findViewById(R.id.txtCourse);
                EditText email = (EditText) view.findViewById(R.id.txtEmail);
                EditText surl = (EditText) view.findViewById(R.id.txtImageUrl);
                        ...
                        FirebaseDatabase.getInstance().getReference().child("students")
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(Exception e) {
                                        Toast.makeText(holder.name.getContext(), "Error Occurred", Toast.LENGTH_SHORT).show();
                                        dialogPlus.dismiss();
                                    }
                                });
                    }
